...
- [How do I fix `Error: listen EADDRINUSE 127.0.0.1:3030`?](#how-do-i-fix-error-listen-eaddrinuse-1270013030)
...
## How do I fix `Error: listen EADDRINUSE 127.0.0.1:3030`?

This simply means that there's another process already listening on port 3030.
...
1. Find the process id (PID):
    ...
    > ```
    > Note: If nothing is listed, you can try `lsof -i tcp:3030`
...
1. Find the process id (PID):
    ...
    > ...
    > TCP       0.0.0.0:3030      0.0.0.0:0         Listening   28344
    ```
